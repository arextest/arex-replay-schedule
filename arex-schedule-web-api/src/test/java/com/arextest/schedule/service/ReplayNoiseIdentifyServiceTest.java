...
public class ReplayNoiseIdentifyServiceTest {
    ...
    public void testAnalysisNoiseFromCompareResult()
        ...
        Method method =
            AsyncNoiseCaseAnalysisTaskRunnable.class.getDeclaredMethod("analysisNoiseFromCompareResult", List.class);
        ...
        String json1 = "{\n" + "    \"planId\": \"6513d8f98303f22897d46740-noisehandler\",\n"
            ...
            + "    \"diffResultCode\": 1,\n" + "    \"msgInfo\": {\n" + "        \"msgMiss\": 0\n" + "    }\n" + "}";
        ReplayCompareResultCollection dao1 = JSON.parseObject(json1, ReplayCompareResultCollection.class);
        ...
        String json2 = "{\n" + "    \"planId\": \"6513d8f98303f22897d46740-noisehandler\",\n"
            ...
            + "    \"diffResultCode\": 1,\n" + "    \"msgInfo\": {\n" + "        \"msgMiss\": 0\n" + "    }\n" + "}";
        ReplayCompareResultCollection dao2 = JSON.parseObject(json2, ReplayCompareResultCollection.class);
    ...
    public interface ReplayCompareResultConverterTest {
        ...
        ReplayCompareResultConverterTest INSTANCE = Mappers.getMapper(ReplayCompareResultConverterTest.class);
