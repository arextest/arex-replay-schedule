package com.arextest.schedule.model.extension;
...
public class DubboInvocation extends GeneralInvocation {
    ...
    public DubboInvocation(String url, Map<String, String> attachments, String interfaceName, String methodName,
        ...
        attributes.put(InvokerConstants.METHOD_NAME, methodName);
        attributes.put(InvokerConstants.INTERFACE_NAME, interfaceName);
        attributes.put(InvokerConstants.HEADERS, attachments);
        attributes.put(InvokerConstants.PARAMETERS, parameters);
        attributes.put(InvokerConstants.PARAMETER_TYPES, parameterTypes);
    }
