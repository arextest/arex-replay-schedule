...
public class InvalidReplayCaseService {
    ...
    private static final long THREE_MINUTES_EXPIRE = 3 * 60;
    ...
    private byte[] toInvalidCaseKeyBytes(String planId) {
        byte[] paramKey = planId.getBytes(StandardCharsets.UTF_8);
