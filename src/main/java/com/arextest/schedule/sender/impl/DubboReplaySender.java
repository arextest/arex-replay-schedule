...
public class DubboReplaySender extends AbstractReplaySender {
    ...
    private static final String EXTENSION_FILE_PATH = "/usr/local/tomcat/webapps/arex_schedule_web_api/WEB-INF/classes/META-INF/dubbo/com.alibaba.dubbo.rpc.Protocol";
