...
abstract class AbstractReplaySender implements ReplaySender {
    ...
    protected ServiceInstance getServiceInstance(String caseItemId, List<ServiceInstance> serviceInstances) {
        if (CollectionUtils.isEmpty(serviceInstances)) {
            return null;
        }
        Integer index = Math.abs(caseItemId.hashCode() % serviceInstances.size());
