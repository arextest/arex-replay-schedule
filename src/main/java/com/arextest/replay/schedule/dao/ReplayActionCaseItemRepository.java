...
import com.arextest.replay.schedule.dao.handler.StringToHashMapHandler;
...
public interface ReplayActionCaseItemRepository extends RepositoryWriter<ReplayActionCaseItem> {
    ...
    @Insert("  INSERT INTO arex_replay_run_details (" +
            ...
            ", #{targetResultId}" +
            ", #{consumeGroup}" +
            ", #{requestHeaders,jdbcType=OTHER,typeHandler=com.arextest.replay.schedule.dao.handler" +
